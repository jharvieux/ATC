...
### 21. Claim-before-send in batch jobs
...
### 22. Collectively-atomic multi-writes
...
### 23. Deterministic idempotency keys on external sends
...
### 24. DB uniqueness wherever app code assumes it
...
### 25. Bounded queries on user-growing tables
...
### 26. Webhook state-application needs ordering protection, not just replay dedup
