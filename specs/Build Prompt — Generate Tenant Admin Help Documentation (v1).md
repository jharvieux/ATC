...
1. For each of the 12 doc files, identify which sections of the v6 spec contain the authoritative behavior. Build a mapping table — produce this in chat before writing any file so the user can confirm coverage. Example shape:
...
1. **Length sanity** — word count per doc; flag any outside the 800–1,500 range (or 2,500 for troubleshooting).
1. **Tone consistency** — re-read all 12 in one pass for voice drift between docs.
