...
-- #1078 follow-up: public.schema_migrations is the retired db-migrate ledger and
-- is dropped in 0030. It is never created on fresh DBs (migration files don't
-- create it), so guard with IF EXISTS to avoid erroring on fresh builds.
