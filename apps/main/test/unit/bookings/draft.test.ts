...
describe("POST /api/bookings/draft", () => {
  ...
  // @rls-covered-by resources=table:public.contacts target=apps/main/test/integration/rls.test.ts#RLS integration contacts + contact_relationships §12.1: userA cannot SELECT tenantB contact (contactBId)
