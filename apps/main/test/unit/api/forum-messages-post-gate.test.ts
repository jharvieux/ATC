...
describe("POST /api/forums/:forumId/threads/:threadId/messages — gate checks (§19.3–19.4)", () => {
  // @rls-covered-by resources=table:public.forums target=apps/main/test/integration/rls.test.ts#RLS integration unit-scope companion policies forums: userB cannot SELECT tenantA rows
  ...
  // @rls-covered-by resources=table:public.forum_threads target=apps/main/test/integration/rls.test.ts#RLS integration unit-scope companion policies forum_threads: userB cannot SELECT tenantA rows
