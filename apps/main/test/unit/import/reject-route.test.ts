...
describe("POST /api/imports/review/[id]/reject (#1330)", () => {
  ...
  // @rls-covered-by resources=table:public.import_queue target=apps/main/test/integration/rls.test.ts#RLS integration unit-scope companion policies import_queue: userB cannot SELECT tenantA rows
