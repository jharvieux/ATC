...
const SECTIONS: HubSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/feedback-settings",       label: "Feedback Settings",         desc: "Tune the §6.10 feedback knobs (adjustment cap, min signals, lookback, decay half-life) — syncs to rag." },
