...
export const personaBase = {
  ...
  expertise_area: {
    ...
    secondary:
      "Cabin type distinctions (fully accessible vs ambulatory vs hearing-impaired), tender port warnings, ship-by-ship accessibility knowledge, adaptive equipment logistics",
  },
  anti_instructions: [
