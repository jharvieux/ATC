...
module.exports = [
  ...
  // BP20: Forum threads list + create — reads forum_threads (coordinator sees all statuses).
  // §19.7. Service-role required: forum_threads RLS is undefined for tenant members.
